...
<div class="pure-g"> 
    <div class="pure-u-1">
      <p>Pulci&nbsp;jsou děti, kterým je <em>9&nbsp;až&nbsp;10&nbsp;let</em>. Běháme stále ještě po cestách a když si nejsme jistí, můžeme se v lese sále ještě držet vyznačené linie. Už si však vystačíme i bez pomoci a vždy jsme se dokázali z lese v pořádku vrátit.</p>
    <hr>
    </div>
