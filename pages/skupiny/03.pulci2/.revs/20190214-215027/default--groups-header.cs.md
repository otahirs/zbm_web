...
<div class="pure-g"> 
    <div class="pure-u-1">
        <p>jsou děti, kterým je <em>9 až 10 let</em>. Naše schůzky jsou uzpůsobeny věku dětí. Na každé z nich se postupně zábavnou formou seznámíme se základy orientačního běhu, zasportujeme si a pohrajeme v přírodě. </p>
    <hr>
    </div>
