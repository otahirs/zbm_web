...
<div class="pure-g"> 
    <div class="pure-u-1">
      <p>Pulci&nbsp;1 jsou děti přibližně od <em>od 6 do cca 9 let</em>. Již se účastníme prvních mapových tréninků, kde se pod pečlivým dozorem s kamarády účíme základům jak používat mapu a buzolu.</p>
        <hr>
    </div>
