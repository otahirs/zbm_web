...
<div class="pure-g">
        ...
        <div class="pure-u-1 pure-u-md-1-2">
            ...
            <div>
                <input placeholder="Číslo" list="cisloList" name="cislo" style="width: 4.5em" required  pattern="[0-9]{2}" oninvalid="this.setCustomValidity('Vyplňte číslo časopisu ve formátu XX')" oninput="setCustomValidity('')" autocomplete="off">
