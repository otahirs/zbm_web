...
<div class="pure-g">
        ...
        <div class="pure-u-1 pure-u-md-1-2">
            ...
            <br>
            <div> 
                <input type="text" placeholder="Rok" list="yearList" name="year" style="width: 12em;" required pattern="[0-9]{4}" oninvalid="this.setCustomValidity('Vyplňte rok ve formátu YYYY')"
            ...
            <br>
            <div>
                <input placeholder="Číslo" type="text" list="cisloList" name="cislo" style="width: 12em" required  pattern="[0-9]{2}" oninvalid="this.setCustomValidity('Vyplňte číslo časopisu ve formátu XX')" oninput="setCustomValidity('')" autocomplete="off">
