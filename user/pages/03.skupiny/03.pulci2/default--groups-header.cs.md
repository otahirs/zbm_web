...
<div class="pure-g"> 
    <div class="pure-u-1">
      <p>Pulci&nbsp;jsou děti, kterým je <em>9&nbsp;až&nbsp;10&nbsp;let</em>. Běháme stále ještě po cestách a když si nejsme jistí, můžeme se v lese držet vyznačené linie. Už si však vystačíme i bez pomoci. Zábavnou formou se seznamujeme s orientačním během a hrajeme si v přírodě.</p>
    <hr>
    </div>
